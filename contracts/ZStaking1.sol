...
import "./interface/IZfuel.sol";
import "hardhat/console.sol";

contract ZStaking1 is ReentrancyGuard, Ownable, Pausable, ERC721Holder {
    ...
    uint256 public zFuelRate = 50;
    uint256 public rewardRate = 0;
    uint256 public consumptionRate = 0;
    uint256 public periodFinish = 0;
    uint256 public deductionCount = 0;
    uint256 public rewardsDuration = 0;
    uint256 public rewardPerHashRateStored;
    uint256 public consumptionPerHashRateStored;
    uint256 public constant BASE_DIVIDER = 100;
    uint256 public constant FIRST_EPOCH_REWARDS = 50 * 6 * 24 * 365 * 4 ether;
