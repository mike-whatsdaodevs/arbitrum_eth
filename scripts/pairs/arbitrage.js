...
async function main() {
  ...
  let path1 = await poolsPrice.getSinglePath(weth9_address, usdc_address, fees[0]);
  let path2 = await poolsPrice.getSinglePath(usdc_address, weth9_address, fees[0]);
  ...
  console.log(await token.balanceOf(pathPrice_address));
