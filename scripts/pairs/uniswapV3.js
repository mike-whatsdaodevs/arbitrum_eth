...
async function main() {
  ...
  let uniV3_facotry_address = process.env.PANCAKEV3;
  ...
  let tx = await pairFiner.setDexFactory(3, uniV3_facotry_address);
  await tx.wait();

  let result = await pairFiner.getUniswapV3PoolAddress(3, wstETH_address, weth9_address, [100, 500, 3000, 10000])
  console.log(result);
